...
export default class Fishes extends React.Component {
	constructor(props){
		super(props);
		this.state = {
			fish1: {mount: false, type: Fish1},
			fish2: {mount: false, type: Fish2},
			fish3: {mount: false, type: Fish3},
			fish4: {mount: false, type: Fish4},
			fish5: {mount: false, type: Fish5},
			fish6: {mount: false, type: Fish6},
			fish7: {mount: false, type: Fish7},
			fish8: {mount: false, type: Fish8},
			fish9: {mount: false, type: Fish9},
			fish10: {mount: false, type: Fish10},
		};
